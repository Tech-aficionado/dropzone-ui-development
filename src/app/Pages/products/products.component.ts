...
export class ProductsComponent {
  ...
  constructor(public router: Router, public getAllProduct: GetAllProductsService,public getProductCat: GetProductCateogriesService, public malproduct: ProductsManipulateService) {}
  ...
  ngOnInit() {
    ...
    this.getProductCat.getProductCategories((response)=>{
      ...
      this.getAllProduct.getAllProducts((response)=>{
        ...
        this.FinalizedProducts = this.productCategoryMapping(this.categories,this.products)
        setTimeout(()=>{
